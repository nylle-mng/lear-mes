  ...
  return (
    <div className="metrics-row">
      <div className="metric-box">
        ...
        <div className={`metric-value ${!mesEnabled ? 'disabled' : ''}`}>
          {mesEnabled ? frequency : '0.00'}
        </div>
      ...
      <div className="metric-box">
        ...
        <div className={`metric-value ${!mesEnabled ? 'disabled' : ''}`}>
          {mesEnabled ? lineState.stopCount.toString().padStart(3, '0') : '000'}
        </div>
      ...
      <div className="metric-box">
        ...
        <div className={`metric-value ${!mesEnabled ? 'disabled' : ''}`}>
          {mesEnabled ? lineState.downtime.toString().padStart(4, '0') : '0000'}
        </div>
      ...
      <div className="metric-box">
        ...
        <div className={`metric-value ${!mesEnabled ? 'disabled' : ''}`} style={{ color: mesEnabled ? 'var(--status-run)' : '', textShadow: mesEnabled ? '0 0 20px var(--status-run-dim)' : '' }}>
          {mesEnabled ? lineState.partsCount.toString().padStart(4, '0') : '0000'}
        </div>
